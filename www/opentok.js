window.OT = {
  ...
  initSession: function (apiKey, sessionId) {
    if (sessionId == null) {
      this.showError(
        'OT.initSession takes 2 parameters, your API Key and Session ID'
      )
    }
...
replaceWithVideoStream = function (element, streamId, properties) {
  ...
  typeClass =
    streamId === PublisherStreamId ? PublisherTypeClass : SubscriberTypeClass
...
TBUpdateObjects = function () {
  ...
  for (_i = 0, _len = objects.length; _i < _len; _i++) {
    ...
    Cordova.exec(TBSuccess, TBError, OTPlugin, 'updateView', [
      streamId,
      position.top,
      position.left,
      position.width,
...
TBPublisher = (function () {
  function TBPublisher(one, two) {
    ...
    if (this.properties != null) {
      ...
      height =
        (_ref1 = this.properties.height) != null ? _ref1 : position.height
      name = (_ref2 = this.properties.name) != null ? _ref2 : ''
      cameraName =
        (_ref3 = this.properties.cameraName) != null ? _ref3 : 'front'
      audioFallbackEnabled =
        (_ref4 = this.properties.audioFallbackEnabled) != null
          ? _ref4
          : audioFallbackEnabled
      audioBitrate =
        (_ref5 = this.properties.audioBitrate) != null ? _ref5 : audioBitrate
      audioSource =
        (_ref6 = this.properties.audioSource) != null ? _ref6 : audioSource
      videoSource =
        (_ref7 = this.properties.videoSource) != null ? _ref7 : videoSource
      frameRate =
        (_ref8 = this.properties.frameRate) != null ? _ref8 : frameRate
      resolution =
        (_ref9 = this.properties.resolution) != null ? _ref9 : resolution
      if (
        this.properties.publishAudio != null &&
        this.properties.publishAudio === false
      ) {
        publishAudio = 'false'
      }
      if (
        this.properties.publishVideo != null &&
        this.properties.publishVideo === false
      ) {
        publishVideo = 'false'
      }
      if (
        this.properties.audioFallbackEnabled != null &&
        this.properties.audioFallbackEnabled === false
      ) {
        audioFallbackEnabled = 'false'
      }
      if (
        this.properties.audioSource != null ||
        this.properties.audioSource === false
      ) {
        audioSource = 'false'
      }
      if (
        this.properties.videoSource != null ||
        this.properties.videoSource === false
      ) {
        videoSource = 'false'
      }
      insertMode =
        (_ref10 = this.properties.insertMode) != null ? _ref10 : insertMode
    }
    ...
    Cordova.exec(TBSuccess, TBError, OTPlugin, 'initPublisher', [
      name,
      position.top,
      position.left,
      width,
    ...
    Cordova.exec(this.eventReceived, TBSuccess, OTPlugin, 'addEvent', [
      'publisherEvents'
    ])
  }
  ...
  TBPublisher.prototype.getImgData = function (callback) {
    ...
    Cordova.exec(successCb, errorCb, OTPlugin, 'getImgData', [
      PublisherStreamId
    ])
    return this
  }
  ...
  TBPublisher.prototype.setCameraPosition = function (cameraPosition) {
    ...
    Cordova.exec(TBSuccess, TBError, OTPlugin, 'setCameraPosition', [
      cameraPosition
    ])
    return this
  }
...
TBSession = (function () {
  TBSession.prototype.connect = function (token, connectCompletionCallback) {
    ...
    this.token = token
    if (
      typeof connectCompletionCallback !== 'function' &&
      connectCompletionCallback != null
    ) {
      TB.showError(
        'Session.connect() takes a token and an optional completionHandler'
      )
      return
    }
    ...
    Cordova.exec(this.eventReceived, TBError, OTPlugin, 'addEvent', [
      'sessionEvents'
    ])
    Cordova.exec(successCallback, errorCallback, OTPlugin, 'connect', [
      this.token
    ])
  }
  ...
  TBSession.prototype.unsubscribe = function (subscriber) {
    ...
    return Cordova.exec(TBSuccess, TBError, OTPlugin, 'unsubscribe', [
      subscriber.streamId
    ])
  }
  ...
  function TBSession(apiKey, sessionId) {
    ...
    this.alreadyPublishing = false
    OT.getHelper().eventing(this)
    Cordova.exec(TBSuccess, TBSuccess, OTPlugin, 'initSession', [
      this.apiKey,
      this.sessionId
    ])
  }
  ...
  TBSession.prototype.streamCreated = function (event) {
    ...
    stream = new TBStream(
      event.stream,
      this.connections[event.stream.connectionId]
    )
  ...
  TBSession.prototype.streamPropertyChanged = function (event) {
    ...
    if (
      ...
      this.publisher.stream.streamId === stream.streamId
    ) {
...
TBSubscriber = (function () {
  ...
  TBSubscriber.prototype.subscribeToAudio = function (value) {
    ...
    Cordova.exec(TBSuccess, TBError, OTPlugin, 'subscribeToAudio', [
      this.streamId,
      state
    ])
    return this
  ...
  TBSubscriber.prototype.subscribeToVideo = function (value) {
    ...
    Cordova.exec(TBSuccess, TBError, OTPlugin, 'subscribeToVideo', [
      this.streamId,
      state
    ])
    return this
  ...
  function TBSubscriber(stream, divObject, properties) {
    ...
    this.videoDisabledWarningLifted = __bind(
      this.videoDisabledWarningLifted,
      this
    )
    ...
    if (properties != null) {
      ...
      if (
        properties.subscribeToVideo != null &&
        properties.subscribeToVideo === false
      ) {
        subscribeToVideo = 'false'
      }
      if (
        properties.subscribeToAudio != null &&
    ...
    ratios = TBGetScreenRatios()
    OT.getHelper().eventing(this)
    Cordova.exec(TBSuccess, TBError, OTPlugin, 'subscribe', [
      stream.streamId,
      position.top,
      position.left,
      width,
  ...
  TBSubscriber.prototype.eventReceived = function (response) {
    ...
    if (evtRecFunc) {
      ...
      console.log(
        `JS: TBSubscriber: no handler for ${response.eventType} event`
      )
    }
  }
...
!(function (window, undefined) {
  ...
  OTHelpers.isArray =
    (OTHelpers.isFunction(Array.isArray) && Array.isArray) ||
    function (vArg) {
  ...
  OTHelpers.isEmpty = function (obj) {
    ...
    if (OTHelpers.isArray(obj) || typeof obj === 'string')
      return obj.length === 0
  ...
  OTHelpers.defineProperties = function (object, getterSetters) {
    for (var key in getterSetters) {
      object[key] = generatePropertyFunction(
        object,
  ...
  var entityRegexes = {
    escape: new RegExp(
      '[' + OTHelpers.keys(entityMap.escape).join('') + ']',
      'g'
    ),
    unescape: new RegExp(
      '(' + OTHelpers.keys(entityMap.unescape).join('|') + ')',
      'g'
    )
  }
  ...
  OTHelpers.statable = function (
    ...
    var setState = function (state) {
      if (currentState !== state) {
        ...
        if (stateChanged && OTHelpers.isFunction(stateChanged))
...
;(function (window, OTHelpers, undefined) {
  OTHelpers.useLogHelpers = function (on) {
    ...
    var makeLogArgumentsSafe = function (args) {
      return args
    }
    ...
    function appendToLogs(level, args) {
      ...
      _logs.push([level, formatDateStamp(), message])
    }
  }
...
;(function (window, OTHelpers, undefined) {
  ...
  OTHelpers.eventing = function (self, syncronous) {
    ...
    function executeListenersAsyncronously(name, args, defaultAction) {
      ...
      OTHelpers.forEach(listeners, function (listener) {
        ...
        function filterHandlerAndContext(_listener) {
          return (
            _listener.context === listener.context &&
            _listener.handler === listener.handler
          )
        }
        ...
        OTHelpers.callAsync(function () {
          try {
            ...
            if (
              _events[name] &&
              OTHelpers.some(_events[name], filterHandlerAndContext)
            ) {
    ...
    var removeAllListenersNamed = function (eventName, context) {
      if (_events[eventName]) {
        if (context) {
          ...
          // match that context
          _events[eventName] = OTHelpers.filter(_events[eventName], function (
            listener
          ) {
    ...
    var addListeners = OTHelpers.bind(function (
      eventNames,
      handler,
      context,
      closure
    ...
    var removeListeners = function (eventNames, handler, context) {
      ...
      OTHelpers.forEach(
        eventNames,
        OTHelpers.bind(function (name) {
          if (_events[name]) {
            _events[name] = OTHelpers.filter(
              _events[name],
    ...
    self.addEventListener = function (eventName, handler, context) {
      OTHelpers.warn(
        'The addEventListener() method is deprecated. Use on() or once() instead.'
      )
    ...
    */
    ...
    self.removeEventListener = function (eventName, handler, context) {
      OTHelpers.warn(
        'The removeEventListener() method is deprecated. Use off() instead.'
      )
    ...
    if (env) {
      addListeners = jasmine
        .createSpy('spy on OTHelpers.eventing.addListeners')
        .andCallFake(addListeners)
      removeListeners = jasmine
        .createSpy('spy on OTHelpers.eventing.removeListeners')
    ...
    return function (type, cancelable) {
      ...
      this.preventDefault = function () {
        if (this.cancelable) {
          ...
          OTHelpers.warn(
            'Event.preventDefault :: Trying to preventDefault ' +
...
;(function (window, OTHelpers, undefined) {
  ...
  OTHelpers.isDisplayNone = function (element) {
    if (
      ...
      OTHelpers.css(element, 'display') === 'none'
    )
      return true
  ...
  //
  OTHelpers.observeStyleChanges = function (
    element,
    stylesToObserve,
    onChange
  ) {
...
;(function (window, OTHelpers, undefined) {
  ...
  var defaultDisplayValueForElement = function (element) {
    ...
    defaultDisplay = defaultDisplays[element.ownerDocument][
      element.nodeName
